...
@injectable()
export class MaintenanceStartMessageTransport implements IMesageRequest {
    
    // Producer
    private producer: Producer;
    private topic: string = "manual-open";
    ...
    public async sendStartMessage(startMessage: StartMessage) {
    ...
    private async sendMessage(message: StartMessage): Promise<boolean> {
        let payload = [
...
export class StartMessage {
    ...
    constructor(machineCode, sequence, maintenanceId, color, timer){
