INSERT INTO
  public."permission" (name, value, active)
VALUES
...
INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Visualizar Dashboard', 'dashboard', true);
...
VALUES
  (
    'Visualizar detalhes de uma instituição',
    'read-institution-detail',
    true
  );
...
INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Listar usuários ', 'read-user', true);
...
INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Adicionar usuário ', 'add-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Editar usuário ', 'edit-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Excluir usuário ', 'read-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Desabilitar usuário ', 'disable-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Habilitar usuário ', 'enable-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Bloquear usuário ', 'block-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Exportar usuários ', 'export-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Imprimir usuários ', 'print-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Importar usuários ', 'import-user', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  (
    'Visualizar estatísticas e dados ',
    'user-data',
    true
  );
...
INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Visualizar ajuda', 'read-help', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Listar Relatórios', 'report-list', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Listar Alarmes', 'alarms-list', true);

INSERT INTO
  public."permission" (name, value, active)
VALUES
  ('Anexar Documento', 'upload-doc', true);

---------------------------------Groups------------------------------------------------------------------------------
INSERT INTO
  public."group" ("name", organization_id)
VALUES
...
INSERT INTO
  public."group" ("name", organization_id)
VALUES
  ('Coordenador da Instituição', NULL);

INSERT INTO
  public."group" ("name", organization_id)
VALUES
  ('Professor da Instituição', NULL);

INSERT INTO
  public."group" ("name", organization_id)
VALUES
  ('Aluno da Instituição', NULL);

--------------------------------------------------------------------------------------------------------------------
INSERT INTO
  public.user_has_group (user_id, group_id)
VALUES
  (
    (
      select
...
-- -----------------------------------------------------
-- Adicionando todas as permissões ao grupo Administrador Sistema
-- -----------------------------------------------------
-- Permissão de administrador
INSERT INTO
  public.group_has_permission (group_id, permission_id)
VALUES
  (
    (
      select
  ...
  (
    ...
    (
      ...
      from
        "permission"
      where
        value = 'print-institution'
    )
  );

-- Permissões relacionadas a visualizações das Organizações
INSERT INTO
  public.group_has_permission (group_id, permission_id)
VALUES
  (
...
-- Permissões relacionadas a visualizações da Central de ajuda
INSERT INTO
  public.group_has_permission (group_id, permission_id)
VALUES
  (
...
-- Permissões relacionadas a visualizações dos menus
INSERT INTO
  public.group_has_permission (group_id, permission_id)
VALUES
  (
...
--     (select id from "permission" where value = 'institution-menu')
--   );
-- INSERT INTO public.group_has_permission
--   (group_id, permission_id)
--   VALUES( 
--     (select id from "group" where name = 'Administrador Sistema'),
--     (select id from "permission" where value = 'schedule-menu')
--   );
-- INSERT INTO public.group_has_permission
--   (group_id, permission_id)
--   VALUES( 
--     (select id from "group" where name = 'Administrador Sistema'),
--     (select id from "permission" where value = 'alarms-list')
--   );
INSERT INTO
  public.group_has_permission (group_id, permission_id)
VALUES
  (
    (
      ...
      from
        "group"
      where
        name = 'Coordenador da Instituição'
    ),
    (
      select
        id
