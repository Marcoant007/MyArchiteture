...
export class PopulateDatabase1624649479766 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
                insert into city (uf, name) values
                ...
                ('RI', 'Agricolândia'),
                ('RI', 'Água Branca'),
                ('RI', 'Alagoinha do Piauí'),
                ('RI', 'Alegrete do Piauí'),
                ('RI', 'Alto Longá'),
                ('RI', 'Altos'),
                ('RI', 'Alvorada do Gurguéia'),
                ('RI', 'Amarante'),
                ('RI', 'Angical do Piauí'),
                ('RI', 'Anísio de Abreu'),
                ('RI', 'Antônio Almeida'),
                ('RI', 'Aroazes'),
                ('RI', 'Aroeiras do Itaim'),
                ('RI', 'Arraial'),
                ('RI', 'Assunção do Piauí'),
                ('RI', 'Avelino Lopes'),
                ('RI', 'Baixa Grande do Ribeiro'),
                ('RI', 'Barra DAlcântara'),
                ('RI', 'Barras'),
                ('RI', 'Barreiras do Piauí'),
                ('RI', 'Barro Duro'),
                ('RI', 'Batalha'),
                ('RI', 'Bela Vista do Piauí'),
                ('RI', 'Belém do Piauí'),
                ('RI', 'Beneditinos'),
                ('RI', 'Bertolínia'),
                ('RI', 'Betânia do Piauí'),
                ...
                ('RI', 'Bocaina'),
                ('RI', 'Bom Jesus'),
                ('RI', 'Bom Princípio do Piauí'),
                ('RI', 'Bonfim do Piauí'),
                ('RI', 'Boqueirão do Piauí'),
                ('RI', 'Brasileira'),
                ('RI', 'Brejo do Piauí'),
                ('RI', 'Buriti dos Lopes'),
                ('RI', 'Buriti dos Montes'),
                ('RI', 'Cabeceiras do Piauí'),
                ('RI', 'Cajazeiras do Piauí'),
                ('RI', 'Cajueiro da Praia'),
                ('RI', 'Caldeirão Grande do Piauí'),
                ('RI', 'Campinas do Piauí'),
                ('RI', 'Campo Alegre do Fidalgo'),
                ('RI', 'Campo Grande do Piauí'),
                ('RI', 'Campo Largo do Piauí'),
                ('RI', 'Campo Maior'),
                ('RI', 'Canavieira'),
                ('RI', 'Canto do Buriti'),
                ('RI', 'Capitão de Campos'),
                ('RI', 'Capitão Gervásio Oliveira'),
                ('RI', 'Caracol'),
                ('RI', 'Caraúbas do Piauí'),
                ('RI', 'Caridade do Piauí'),
                ('RI', 'Castelo do Piauí'),
                ('RI', 'Caxingó'),
                ('RI', 'Cocal'),
                ('RI', 'Cocal de Telha'),
                ('RI', 'Cocal dos Alves'),
                ('RI', 'Coivaras'),
                ('RI', 'Colônia do Gurguéia'),
                ('RI', 'Colônia do Piauí'),
                ('RI', 'Conceição do Canindé'),
                ('RI', 'Coronel José Dias'),
                ('RI', 'Corrente'),
                ('RI', 'Cristalândia do Piauí'),
                ('RI', 'Cristino Castro'),
                ('RI', 'Curimatá'),
                ('RI', 'Currais'),
                ('RI', 'Curralinhos'),
                ('RI', 'Curral Novo do Piauí'),
                ('RI', 'Demerval Lobão'),
                ('RI', 'Dirceu Arcoverde'),
                ('RI', 'Dom Expedito Lopes'),
                ('RI', 'Domingos Mourão'),
                ('RI', 'Dom Inocêncio'),
                ('RI', 'Elesbão Veloso'),
                ('RI', 'Eliseu Martins'),
                ...
                ('RI', 'Ilha Grande'),
                ('RI', 'Inhuma'),
                ('RI', 'Ipiranga do Piauí'),
                ('RI', 'Isaías Coelho'),
                ('RI', 'Itainópolis'),
                ('RI', 'Itaueira'),
                ('RI', 'Jacobina do Piauí'),
                ('RI', 'Jaicós'),
                ('RI', 'Jardim do Mulato'),
                ('RI', 'Jatobá do Piauí'),
                ('RI', 'Jerumenha'),
                ...
                ('RI', 'Joca Marques'),
                ('RI', 'José de Freitas'),
                ('RI', 'Juazeiro do Piauí'),
                ('RI', 'Júlio Borges'),
                ('RI', 'Jurema'),
                ('RI', 'Lagoinha do Piauí'),
                ('RI', 'Lagoa Alegre'),
                ('RI', 'Lagoa do Barro do Piauí'),
                ('RI', 'Lagoa de São Francisco'),
                ('RI', 'Lagoa do Piauí'),
                ('RI', 'Lagoa do Sítio'),
                ('RI', 'Landri Sales'),
                ('RI', 'Luís Correia'),
                ...
                ('RI', 'Milton Brandão'),
                ('RI', 'Monsenhor Gil'),
                ('RI', 'Monsenhor Hipólito'),
                ('RI', 'Monte Alegre do Piauí'),
                ('RI', 'Morro Cabeça no Tempo'),
                ('RI', 'Morro do Chapéu do Piauí'),
                ('RI', 'Murici dos Portelas'),
                ('RI', 'Nazaré do Piauí'),
                ('RI', 'Nazária'),
                ('RI', 'Nossa Senhora de Nazaré'),
                ('RI', 'Nossa Senhora dos Remédios'),
                ('RI', 'Novo Oriente do Piauí'),
                ('RI', 'Novo Santo Antônio'),
                ('RI', 'Oeiras'),
                ('RI', 'Olho DÁgua do Piauí'),
                ('RI', 'Padre Marcos'),
                ('RI', 'Paes Landim'),
                ('RI', 'Pajeú do Piauí'),
                ('RI', 'Palmeira do Piauí'),
                ('RI', 'Palmeirais'),
                ('RI', 'Paquetá'),
                ('RI', 'Parnaguá'),
                ('RI', 'Parnaíba'),
                ('RI', 'Passagem Franca do Piauí'),
                ('RI', 'Patos do Piauí'),
                ('RI', 'Pau DArco do Piauí'),
                ('RI', 'Paulistana'),
                ('RI', 'Pavussu'),
                ('RI', 'Pedro II'),
                ('RI', 'Pedro Laurentino'),
                ...
                ('RI', 'Piripiri'),
                ('RI', 'Porto'),
                ('RI', 'Porto Alegre do Piauí'),
                ('RI', 'Prata do Piauí'),
                ('RI', 'Queimada Nova'),
                ('RI', 'Redenção do Gurguéia'),
                ('RI', 'Regeneração'),
                ('RI', 'Riacho Frio'),
                ('RI', 'Ribeira do Piauí'),
                ('RI', 'Ribeiro Gonçalves'),
                ('RI', 'Rio Grande do Piauí'),
                ('RI', 'Santa Cruz do Piauí'),
                ('RI', 'Santa Cruz dos Milagres'),
                ('RI', 'Santa Filomena'),
                ('RI', 'Santa Luz'),
                ('RI', 'Santana do Piauí'),
                ('RI', 'Santa Rosa do Piauí'),
                ('RI', 'Santo Antônio de Lisboa'),
                ('RI', 'Santo Antônio dos Milagres'),
                ('RI', 'Santo Inácio do Piauí'),
                ('RI', 'São Braz do Piauí'),
                ('RI', 'São Félix do Piauí'),
                ('RI', 'São Francisco de Assis do Piau'),
                ('RI', 'São Francisco do Piauí'),
                ('RI', 'São Gonçalo do Gurguéia'),
                ('RI', 'São Gonçalo do Piauí'),
                ('RI', 'São João da Canabrava'),
                ('RI', 'São João da Fronteira'),
                ('RI', 'São João da Serra'),
                ('RI', 'São João da Varjota'),
                ('RI', 'São João do Arraial'),
                ('RI', 'São João do Piauí'),
                ('RI', 'São José do Divino'),
                ('RI', 'São José do Peixe'),
                ('RI', 'São José do Piauí'),
                ('RI', 'São Julião'),
                ('RI', 'São Lourenço do Piauí'),
                ('RI', 'São Luis do Piauí'),
                ('RI', 'São Miguel da Baixa Grande'),
                ('RI', 'São Miguel do Fidalgo'),
                ('RI', 'São Miguel do Tapuio'),
                ('RI', 'São Pedro do Piauí'),
                ('RI', 'São Raimundo Nonato'),
                ('RI', 'Sebastião Barros'),
                ('RI', 'Sebastião Leal'),
                ('RI', 'Sigefredo Pacheco'),
                ('RI', 'Simões'),
                ('RI', 'Simplício Mendes'),
                ('RI', 'Socorro do Piauí'),
                ('RI', 'Sussuapara'),
                ('RI', 'Tamboril do Piauí'),
                ('RI', 'Tanque do Piauí'),
                ('RI', 'Teresina'),
                ('RI', 'União'),
                ('RI', 'Uruçuí'),
                ...
                ('MT', 'Luciara'),
                ('MT', 'Vila Bela da Santíssima Trinda'),
                ('MT', 'Marcelândia'),
                ('MT', 'Matupá'),
                ('MT', 'Mirassol dOeste'),
                ('MT', 'Nobres'),
        ...
        `);
        await queryRunner.query(`
            insert  into status_organization (id, created_at, updated_at, status) 
            values (default, now(), now(), 'Ativo');
            
            insert  into status_organization (id, created_at, updated_at, status) 
            values (default, now(), now(), 'Bloqueado');
            
            insert  into status_organization (id, created_at, updated_at, status) 
            values (default, now(), now(), 'Desabilitado');
        `);
        ...
        await queryRunner.query(`
            ...
            values 
                ...
                '2730622875',
                '2730192993',
                'contato@etaure.com.br',
                1,
                'Ednaldo Pereira',
                'Ednaldo pereira descrição',
                'Nome da companhia pereira',
                '40028922');
        `);
        await queryRunner.query(`
            ...
            values
                ...
                now(),
                'AdminEachOne',
                '$2a$08$vl6oLemJxDfl6CqIliw.vu//Jzr7dFXgIa7.xWltjge4fes2K8nfW',
                '178167837528',
                'matricula202015',
                'Administrador',
                true,
                'eachonetest@gmail.com',
                true,
                null,
                null,
                'matricula');
        ...
        await queryRunner.query(`
        INSERT INTO charge
        (id, created_at, updated_at, value, billing_date, expiration_date, payment_date, status, organization_id)
        values
        (default, now(), now(), 45, now(), now(), now(), 'normal', 1);
        `);
        await queryRunner.query(`
        INSERT INTO credit_card
        (id, created_at, updated_at, created_by, name, month, year, number, code, status, default_card, organization_id)
        values
        (default, now(), now(), 1, 'Mastercard', 11, 2025, 5455542280892589,  456, 'ativo', true, 1);
        `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM user;`);
        await queryRunner.query(`DELETE FROM status_organization;`);
    }
